                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="content-top-agile p-10">
                            <img style='width:150px;height:130px;' src="{{ asset('backend/images/logo/logo.png')}}" alt="log" />
                            <h3 class="text-white">University of Sri Jayewardenapura</h3>
                            <p class="text-dark-100">Physical Education and Sports Center (PESC)</p>                          
                        </div>
